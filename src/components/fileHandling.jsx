...
// Temporary quickfix. A more modular implementation coming soon!

function NewGrid({reference, updateBackground}) {
  const [isNewGridConfirm, toggleConfirm] = useState(false)
  ...
  const handleNewGrid = () => {
    ...
    reference.current.handleClearGrid()
    handleClose()
  }
  ...
  return (
    <>
      <a 
        ...
        onClick={handleClick}
      >New Grid</a>
      <div className={"modal " + (isNewGridConfirm ? "is-active": "")}>
        <div className="modal-background" onClick={handleClose}></div>
        <div className="modal-card">
          <section className="modal-card-body">
            Are you sure you want to start a new grid?
          </section>
          <footer className="modal-card-foot">
            <button className="button is-danger" onClick={handleNewGrid}>Confirm</button>
...
export {SaveGrid, LoadGrid, ExportPalette, NewGrid}
